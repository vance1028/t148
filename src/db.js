...
async function resetAll() {
  ...
  try {
    ...
    const tables = [
      'debt_writeoffs', 'debt_payments', 'parking_debts',
      'credit_score_logs', 'credit_scores', 'credit_rules',
      'vehicle_blacklists', 'risk_rules', 'system_configs',
      'parking_sessions', 'parking_spaces', 'vehicles',
      'parking_lots', 'users',
    ];
