...
async function ensureRuntimeInit() {
  await debtService.ensureDefaultConfigs();
  await riskService.ensureDefaultRiskRules();
  await creditService.ensureDefaultCreditRules();
}

module.exports = { createApp, ensureRuntimeInit };
